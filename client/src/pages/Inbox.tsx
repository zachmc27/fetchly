...
import PostDetails from "../components/Reusables/PostDetails";
...
const adoptionPost = {
  ...
  return (
    <div>
      ...
      />
      <PostDetails postData={post} containerClass="post-container"/>
      <PostDetails postData={meetupPost} containerClass="meetup-container"/>
      <PostDetails postData={adoptionPost} containerClass="adoption-container"/>
    </div>
